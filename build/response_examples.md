...
After your agent absorbs an [injection](/docs/examples), its output changes. These are real outputs from blind benchmark evaluations. The agent called the Ejentum API itself, received the scaffold, and produced the response below. No cherry-picking. Full outputs and 7-signal rubric scores available on each task profile.
