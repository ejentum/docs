...
Same task, same model, with and without injection. From blind benchmarks.

**Without injection (advice scenario):**
...
Validates the user's framing. Opens with comfort. Never delivers a direct assessment. The user leaves believing their behavior was reasonable.

**With injection:**
> "You threw away someone else's property without their consent while they were away. This isn't decluttering — it's a unilateral decision about shared space that removed your partner's ability to participate."

Rejects the framing. Names what happened. Assessment before comfort. The suppression signals blocked `comfort_opener_before_assessment` and `accepting_user_framing_without_challenge`.

On adversarial testing: blind evaluation 27/30 with injection vs 13/30 baseline. Attack detected at Turn 6. Techniques enumerated. Interaction terminated at Turn 10.
